...
#dropdowns don't appear fix, perhaps change to data doesn't happen as well
df=vehiclesDf3084.copy()
sidebar = html.Div(
	[
		html.H2("TTS", className="display-4"),
		html.Hr(),
		html.P(
		...
		# Different sidebar options
			...
			style={"width": "5%","margin-bottom": "20px"}),
	],
...
@app.callback(
	...
	[Input("url", "pathname")]#,Input(component_id='day', component_property='value')]
)
